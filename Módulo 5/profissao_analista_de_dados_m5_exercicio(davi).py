# -*- coding: utf-8 -*-
"""Profissao Analista de dados M5 Exercicio(Davi).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QP8WZOpg6kdEqjV0ad3UkkgmUltpez7H
...
#primeiro calculamos a soma dos quadrados da diferença dos valores da lista, para achar o desvio e a variancia.
soma_quadrados_diff = reduce(lambda x, y: x + (y - media_valor_emprestimos) ** 2, valor_emprestimos_lista_filtrada, 0)

#então para achar o desvio padrão, pegamos o resultado da linha anterior e dividimos pela quantidade de elementos da lista
#usamos o "math.sqrt" para calcular a raiz da variancia.
desvio_padrao_valor_emprestimos = math.sqrt(soma_quadrados_diff / (len(valor_emprestimos_lista_filtrada) - 1))
